...
3. Create `~/.config/seoskillsai/gsc_ga4.json` (mode `0o600`) with Desktop client id, client password, offline grant, and optional `ga4_property_id`. Do not commit this file.
