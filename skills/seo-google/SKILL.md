...
Create `~/.config/seoskillsai/google_credentials.json` (mode `0o600`) and run `python scripts/google_installed_app.py --setup`. Scopes: `webmasters.readonly`, `analytics.readonly`.
